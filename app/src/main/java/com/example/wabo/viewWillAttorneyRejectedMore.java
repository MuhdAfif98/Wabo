...
public class viewWillAttorneyRejectedMore extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_will_attorney_rejected_more);
        ...
        buttonReturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), viewWillAttorneyRejected.class));
            }
        });
